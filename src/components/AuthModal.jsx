...
import { X, Mail, Lock, User, LogIn, ArrowLeft, CheckCircle } from 'lucide-react'
          ...
          {mode === 'reset' ? (
            <>
              <button
                ...
                className="mb-4 flex items-center gap-1.5 text-xs text-slate-400 hover:text-white transition-colors"
              >
